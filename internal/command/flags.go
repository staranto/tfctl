...
var (
	...
	GlobalFlags = []cli.Flag{
		&cli.StringFlag{
			Name:    "attrs",
			Aliases: []string{"a"},
			Usage:   "comma-seperated list of attributes to include in results",
		},
		&cli.BoolFlag{
			Name:        "color",
			Aliases:     []string{"c"},
		...
		&cli.StringFlag{
			Name:    "filter",
			Aliases: []string{"f"},
			Usage:   "comma-seperated list of filters to apply to results",
		},
		&cli.StringFlag{
			Name:    "output",
			Aliases: []string{"o"},
		...
		&cli.StringFlag{
			Name:    "sort",
			Aliases: []string{"s"},
			Usage:   "comma-seperated list of attributes to sort the results by",
		},
		&cli.BoolFlag{
			Name:        "titles",
			Aliases:     []string{"t"},
