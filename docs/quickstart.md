...
- `tfctl` installed and in your PATH. If installed via Homebrew or the Debian package, manual pages are available (e.g., `man tfctl`).
  - If you installed from a tarball, see “Install man pages (from tarball)” and “Install TLDR pages (from tarball)” in the project README to set up local man and TLDR pages.
